...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("ViewerChannel", {
  ...
  received: function received(data) {
    ...
    if (data.content.type = "new_user") {
      ...
      var textNode = document.createTextNode(data.content.user);
      node.id = data.content.id;
      node.className("attendee");
      node.appendChild(textNode);
      document.getElementById("attendees").appendChild(node);
    }
  }
});
...
/******/ });
//# sourceMappingURL=application-ad9725c1ccb1d6acce26.js.map