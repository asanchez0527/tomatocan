...
/* WEBPACK VAR INJECTION */(function($) {// get session variables
...
function loadAttendees() {
  $.get("/conversations/attendees", {
    room: room,
    user: current_user,
    owner: owner
  }, function (data) {
    if (data.success == true) $('#attendees').html(data.html);
  });
}
...
/******/ });
//# sourceMappingURL=viewer-33054d0885cf17e0e065.js.map