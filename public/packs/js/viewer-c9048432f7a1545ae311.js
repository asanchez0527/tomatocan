...
/* WEBPACK VAR INJECTION */(function($) {// var name = $("#user_vars").data("name")
...
var permalink = $("meta[property='user-permalink']").attr('content'); // load user to attendees table
  ...
  $.post("/conversations/attendees", {
    ...
    data.forEach(function (element) {
      ...
      name.onclick = function () {
        alert("".concat(element.user_permalink));
        window.open("/".concat(element.user_permalink));
      };
...
/******/ });
//# sourceMappingURL=viewer-c9048432f7a1545ae311.js.map