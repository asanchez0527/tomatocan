...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("ViewerChannel", {
  ...
  received: function received(data) {
    ...
    } else if (data.content.type == "block") {// $.post("/users/is_blocked", {current_user: currentUserId, id: data.content.id}, (data) => {
      // })
    }
  }
});
...
/******/ });
//# sourceMappingURL=application-e57d9b993d2661220b76.js.map