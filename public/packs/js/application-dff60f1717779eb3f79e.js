...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("ViewerChannel", {
  ...
  received: function received(data) {
    ...
    if (data.content.type = "new_user") {
      ...
      document.getElementById("attendees").appendChild(attendee); // $("#2").append("<%= image_tag 'logoDigitalHollow300.png'%>")
...
__webpack_require__(/*! channels/consumer.js */ "./app/javascript/channels/consumer.js");

__webpack_require__(/*! channels/viewer_channel.js.erb */ "./app/javascript/channels/viewer_channel.js.erb"); // Uncomment to copy all static images under ../images to the output folder and reference
...
/******/ });
//# sourceMappingURL=application-dff60f1717779eb3f79e.js.map