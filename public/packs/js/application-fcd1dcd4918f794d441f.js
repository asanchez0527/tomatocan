  ...
  received: function received(data) {
    ...
    if (data.content.type == "join") {
      ...
      span.onclick = function () {
        window.open("/".concat(data.content.permalink));
      };
      ...
      if ($("meta[property='user-id']").attr('content') == data.content.id) {
        window.location.replace("https://cdn.memes.com/up/39569001566352904/i/1597259986921.jpg");
      }
...
/******/ });
//# sourceMappingURL=application-fcd1dcd4918f794d441f.js.map